...
public class CustomerController extends BaseController{
	...
	@PostMapping("/list")
	public Map<String, Object> list(@RequestBody CustomerFilterDTO filterDTO, @RequestParam(defaultValue = "0") int page,
			@RequestParam(defaultValue = "10") int size) {

		Pageable pageable = PageRequest.of(page, size,
				Sort.by(Sort.Order.desc("status"), Sort.Order.asc("code"))
		);
