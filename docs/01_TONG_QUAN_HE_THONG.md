...
| Nhân viên doanh nghiệp | Lập hóa đơn, import hóa đơn, import danh mục khách hàng/sản phẩm, quản lý khách hàng, sản phẩm, báo cáo theo quyền được cấp. |
| Quản lý doanh nghiệp | Quản lý hồ sơ công ty, thành viên, phân quyền nội bộ, cấu hình bảo mật và email. |
| Quản trị viên hệ thống | Vào khu quản trị, xử lý danh mục và cấu hình cấp hệ thống theo quyền. |
...
| Nhóm | Chức năng |
| --- | --- |
| Xác thực | Đăng nhập người dùng, đăng nhập khu quản trị, JWT, phiên đăng nhập, kiểm tra IP. |
...
- Quản trị viên toàn quyền có thể xem hoặc thao tác nhiều công ty khi API cho phép, nhưng dữ liệu công ty thường không được ghi nhầm về công ty root.
...
| --- | --- |
| Người truy cập công khai | Đăng ký công ty, đăng nhập, quên mật khẩu, tra cứu hóa đơn công khai. |
| Nhân viên doanh nghiệp | Thao tác nghiệp vụ theo quyền được cấp. |
| Quản lý doanh nghiệp | Quản lý hồ sơ công ty, thành viên, phân quyền và cấu hình trong phạm vi công ty. |
| Quản trị viên hệ thống | Truy cập khu quản trị hệ thống theo quyền. |
| Quản trị viên toàn quyền | Toàn quyền hệ thống. |
...
| F03 | Quản lý hồ sơ công ty, người đại diện, ngân hàng, cơ quan thuế, thông tin hiển thị hóa đơn. | Quản lý doanh nghiệp |
| F04 | Quản lý thành viên, khóa/mở khóa, reset mật khẩu và phân quyền. | Quản lý doanh nghiệp |
| F05 | Quản lý khách hàng và sản phẩm theo công ty, gồm thêm, sửa, xóa, tìm kiếm và nạp nhanh khi lập hóa đơn. | Nhân viên doanh nghiệp |
...
| F09 | Import hóa đơn, khách hàng và sản phẩm từ Excel; xem lịch sử import theo công ty. | Nhân viên doanh nghiệp |
| F10 | Gửi email hóa đơn và xem lịch sử gửi mail theo công ty. | Nhân viên doanh nghiệp |
...
| Phân quyền | Quản trị viên toàn quyền có quyền cao nhất; Quản trị viên hệ thống vào khu quản trị; Quản lý doanh nghiệp quản lý trong phạm vi công ty; Nhân viên doanh nghiệp dùng quyền được gán chi tiết. |
...
| --- | --- | --- |
| UC01 | Đăng ký công ty | Người truy cập công khai |
| UC02 | Duyệt hồ sơ đăng ký công ty | Quản trị viên hệ thống |
| UC03 | Đăng nhập hệ thống | Người dùng, admin |
| UC04 | Quản lý thành viên và phân quyền | Quản lý doanh nghiệp |
| UC05 | Quản lý hồ sơ công ty | Quản lý doanh nghiệp |
| UC06 | Quản lý khách hàng | Nhân viên doanh nghiệp |
| UC07 | Quản lý sản phẩm | Nhân viên doanh nghiệp |
| UC08 | Tạo và gửi tờ khai | Nhân viên doanh nghiệp |
| UC09 | Quản lý mẫu hóa đơn | Nhân viên doanh nghiệp |
| UC10 | Lập hóa đơn GTGT | Nhân viên doanh nghiệp |
| UC11 | Ký và phát hành hóa đơn | Nhân viên doanh nghiệp |
| UC12 | Gửi hóa đơn qua email | Nhân viên doanh nghiệp |
| UC13 | Import hóa đơn từ Excel | Nhân viên doanh nghiệp |
| UC14 | Xem báo cáo hóa đơn | Nhân viên doanh nghiệp |
| UC15 | Mua gói hóa đơn | Nhân viên doanh nghiệp |
| UC16 | Quản lý danh mục nền | Quản trị viên hệ thống |
| UC17 | Cấu hình báo cáo hóa đơn ngày | Quản trị viên hệ thống |
| UC18 | Tra cứu hóa đơn công khai | Người truy cập công khai |
| UC19 | Import danh mục khách hàng/sản phẩm từ Excel | Nhân viên doanh nghiệp |

### UC01 - Đăng ký công ty

| Mục | Nội dung |
| --- | --- |
| Tác nhân | Người truy cập công khai. |
| Điều kiện trước | Người đăng ký có thông tin công ty, mã số thuế, email và thông tin tài khoản quản lý doanh nghiệp ban đầu. |
...
| Kết quả | Hồ sơ đăng ký ở trạng thái chờ duyệt để Quản trị viên hệ thống xử lý. |
...
| Điều kiện trước | Có hồ sơ đăng ký công ty đang chờ duyệt và Quản trị viên hệ thống có quyền quản lý công ty. |
| Luồng chính | Quản trị viên hệ thống xem danh sách hồ sơ, kiểm tra thông tin, duyệt hồ sơ; hệ thống tạo công ty, tài khoản Quản lý doanh nghiệp, cập nhật trạng thái hồ sơ và có thể gửi thông tin đăng nhập qua email. |
| Kết quả | Công ty và tài khoản Quản lý doanh nghiệp được tạo, hồ sơ chuyển sang trạng thái đã duyệt. |
...
| Mục | Nội dung |
| --- | --- |
| Tác nhân | Người dùng doanh nghiệp hoặc Quản trị viên hệ thống. |
...
| Mục | Nội dung |
| --- | --- |
| Tác nhân | Quản lý doanh nghiệp. |
| Điều kiện trước | Quản lý doanh nghiệp đã đăng nhập, công ty hợp lệ, có quyền `setting-member-list`, `setting-member-save` hoặc `setting-member-manage` tùy thao tác. |
| Luồng chính | Quản lý doanh nghiệp xem danh sách thành viên, thêm hoặc cập nhật thông tin thành viên, gán quyền chi tiết, khóa/mở khóa, reset mật khẩu hoặc gửi thông tin đăng nhập. |
| Kết quả | Thành viên và quyền trong công ty được cập nhật đúng phạm vi công ty. |
| Ngoại lệ | Thiếu quyền, username/email không hợp lệ, thao tác vượt phạm vi công ty, thao tác lên tài khoản quản trị/quản lý không được phép hoặc gửi email thất bại. |
...
| Luồng chính | Quản lý doanh nghiệp cập nhật thông tin công ty, người đại diện, thông tin hóa đơn, liên hệ, ngân hàng, cơ quan thuế, logo và favicon. |
...
| --- | --- |
| Tác nhân | Quản trị viên hệ thống. |
| Điều kiện trước | Quản trị viên có quyền tương ứng: `bank-*`, `tax-authority-*`, `vat-rate-*`. |
| Luồng chính | Quản trị viên hệ thống quản lý ngân hàng, cơ quan thuế và thuế suất; hệ thống lưu trạng thái, thứ tự ưu tiên và dữ liệu nền để các form nghiệp vụ sử dụng. |
...
| Luồng chính | Quản trị viên hệ thống bật lịch gửi, chọn giờ/phút, hệ thống lưu cấu hình, scheduler tự gửi báo cáo ngày hôm qua khi đến giờ. |
...
4. Quản trị viên hệ thống duyệt hồ sơ trong khu quản trị.
5. Hệ thống tạo công ty, tài khoản Quản lý doanh nghiệp và dữ liệu nền cần thiết.
...
1. Quản trị viên hệ thống cấu hình lịch gửi trong màn báo cáo hóa đơn ngày.
...
#### 3.3 Quản Lý Doanh Nghiệp

Quản lý doanh nghiệp có thêm quyền:
...
Tài khoản Quản lý doanh nghiệp có `role = 2`. Đây là tài khoản quản lý nội bộ của doanh nghiệp, dùng được các chức năng người dùng trong phạm vi công ty và được mặc định qua các quyền user level 0.

Tài khoản Quản lý doanh nghiệp không có `admin_password`, không đăng nhập được khu `/administrator` và không hiển thị dropdown `Quản trị` ở header.

#### 3.4 Quản Trị Viên Hệ Thống Và Quản Trị Viên Toàn Quyền

Quản trị viên hệ thống (`role = 1`, thuộc công ty root) hoặc Quản trị viên toàn quyền (`role = 0`) có thể:
...
Các route admin yêu cầu token admin hợp lệ của Quản trị viên toàn quyền hoặc Quản trị viên hệ thống. Các route cấu hình phía doanh nghiệp như thành viên, lịch sử đăng nhập và bảo mật IP cho phép theo quyền backend, trong đó Quản lý doanh nghiệp được quản lý trong phạm vi công ty của mình.
...
Quản trị viên toàn quyền có `role = 0` được phép toàn bộ. Quản trị viên hệ thống có `role = 1`, được vào khu quản trị và dùng các quyền admin được gán. Quản lý doanh nghiệp có `role = 2`, được mặc định qua các quyền user level 0. Nhân viên doanh nghiệp có `role = 3`, cần được gán quyền trong `user_permissions`.

Vì Quản lý doanh nghiệp tự có quyền user level 0 nên không cần insert `user_permissions` cho các quyền user level 0. Nhân viên doanh nghiệp vẫn kiểm tra theo `user_permissions`.
...
#### 6.2 Quản Trị Viên Hệ Thống Duyệt Hồ Sơ

Quản trị viên hệ thống xử lý tại `/administrator/company-registration/list`.

Khi duyệt:

- Tạo công ty mới.
- Tạo tài khoản Quản lý doanh nghiệp.
...
- Đặt vai trò quản lý/quản trị nếu user hiện tại đủ quyền.
...
- Quản trị viên toàn quyền có thể xem rộng hơn, Quản lý doanh nghiệp xem trong phạm vi công ty.
...
- Tạo tài khoản Quản lý doanh nghiệp.
- Gửi thông tin đăng nhập cho Quản lý doanh nghiệp.
...
- Quyền mới tạo có thể được tự gán cho Quản trị viên toàn quyền.
- Một số quyền level thấp có thể dùng cho Quản lý doanh nghiệp hoặc Nhân viên doanh nghiệp tùy cấu hình.
...
- Quản trị viên hệ thống thao tác dữ liệu toàn hệ thống theo quyền được cấp.
- Quản trị viên toàn quyền có quyền toàn bộ.
- Quản lý doanh nghiệp (`role = 2`) được cho qua quyền user level 0; Nhân viên doanh nghiệp (`role = 3`) phải có quyền được gán trong `user_permissions`.
- Quản trị viên hệ thống (`role = 1`) và Quản trị viên toàn quyền (`role = 0`) mới có mật khẩu quản trị riêng và menu quản trị ở header.
...
- `/auth/login-admin`: đăng nhập khu quản trị.
...
- `/administrator`: dashboard quản trị.
